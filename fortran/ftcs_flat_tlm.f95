...
!
!  Differentiation of ftcs_flat in forward (tangent) mode:
...
&   phi0d(length)) + dt*f*n0d(1) + coeff3*(m0d(length)-2.d0*m0d(1)+m0d(2&
&   ))
...
&     phi0d(j-1)) + dt*f*n0d(j) + coeff3*(m0d(j-1)-2.d0*m0d(j)+m0d(j+1))
...
&   length-1)) + dt*f*n0d(length) + coeff3*(m0d(length-1)-2.d0*m0d(&
&   length)+m0d(1))
